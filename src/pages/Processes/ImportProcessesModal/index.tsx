...
const validationSchema = yup.object({
    ...
    file: yup
        .mixed()
        .test('fileType', 'Formato inválido. Insira um .xlsx ou .xls.', (value: any) => {
...
export function ImportProcessesModal({isOpen, onClose, afterSubmission}: ImportProcessesModalProps) {
    ...
    const onSubmit = handleSubmit(async (formData: { file: File; name: string; }) => {

        handleLoading(true);

        const res  = await importFile({ file: formData.file, name: formData.name });
