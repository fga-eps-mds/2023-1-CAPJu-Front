...
export const mdsStudents20231 = [
  "Ana Karoliny de Souza Cavalcanti",
  "Artur Jackson Leal Fontineli",
...
export const epsStudents20222 = [
  "Antônio Aldísio",
  "Davi Antônio da Silva",
  "Fernando Miranda",
  "João Vitor Ferreira",
];

export const mdsStudents20222 = [
  "Ana Luiza Rodrigues",
  "Chaydson Ferreira",
  "Henrique Pucci",
  "Lucas Frazão",
